...
var _joins = __webpack_require__(20);
...
Reflux.connect = __webpack_require__(42);

Reflux.connectFilter = __webpack_require__(43);

Reflux.ListenerMixin = __webpack_require__(12);

Reflux.listenTo = __webpack_require__(44);

Reflux.listenToMany = __webpack_require__(45);
...
var _createAction = __webpack_require__(41);

var _createStore = __webpack_require__(21);

var _Keep = __webpack_require__(10);
...
var _ = __webpack_require__(0),
    ListenerMethods = __webpack_require__(2);
...
var _mixer = __webpack_require__(39);

var _bindMethods = __webpack_require__(40);
...
var PhonesList = __webpack_require__(37);

ReactDOM.render(React.createElement(PhonesList, null), document.getElementById("container"));
...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(3),m=__webpack_require__(15),p=__webpack_require__(6),v=__webpack_require__(4),da=__webpack_require__(16),ea=__webpack_require__(17),fa=__webpack_require__(18),ha=__webpack_require__(7);
...
var PhonesStore = __webpack_require__(48);

var PhonesList = function (_Reflux$Component) {
    _inherits(PhonesList, _Reflux$Component);

    function PhonesList(props) {
        _classCallCheck(this, PhonesList);

        var _this = _possibleConstructorReturn(this, (PhonesList.__proto__ || Object.getPrototypeOf(PhonesList)).call(this, props));

        _this.state = { newItem: "" };
        _this.store = PhonesStore;
    ...
    _createClass(PhonesList, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                "div",
                null,
                React.createElement("input", { type: "text", value: this.state.newItem, onChange: this.onInputChange }),
                React.createElement(
                    "button",
                ...
                React.createElement(
                    ...
                    this.state.phones.map(function (item) {
                        ...
                        return React.createElement(Phone, { key: item, text: item, onRemove: remove });
                    })
                )
            );
        }
...
var ListenerMethods = __webpack_require__(2),
    ListenerMixin = __webpack_require__(12),
...
var Reflux = __webpack_require__(9);
Reflux.defineReact = __webpack_require__(47);
...
// otherwise we're gonna resort to 'try' stuff in case of other environments
	...
	try {
		var R = __webpack_require__(3); // we ignore this in browserify manually (see grunt file), so it's more of a doublecheck for in node
...
var PhonesStore = function (_Reflux$Store) {
  _inherits(PhonesStore, _Reflux$Store);
  ...
  function PhonesStore() {
    ...
    _this.state = { phones: ["iPhone 7", "Samsung Galaxy S8"] };

    _this.listenTo(Actions.addItem, _this.onAddItem);
    _this.listenTo(Actions.removeItem, _this.onRemoveItem);
    return _this;
  }

  _createClass(PhonesStore, [{
    key: "onAddItem",
    value: function onAddItem(phone) {

      this.state.phones.push(phone);
    }
  }, {
    key: "onRemoveItem",
    value: function onRemoveItem(phone) {
